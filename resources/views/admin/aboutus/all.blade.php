        ...
        <div class="page-bar">
            ...
            <div class="page-toolbar">
                <div class="btn-group pull-right">
                    <a href="{{route('aboutus.create')}}" class="btn btn-outline-primary">Create</a>
                </div>
            </div>
        </div>
        <!-- END PAGE BAR -->
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            <form method="POST" action="{{route('statusAboutus',$item->id)}}">
                                            @method('PUT')
                                            @csrf
                                        ...
                                        <td> 
                                            <a href="{{route('aboutus.edit', $item->id)}}" class="btn btn-primary">Edit</a>
                                        </td>
                                        <td>
