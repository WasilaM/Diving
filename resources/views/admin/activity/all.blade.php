        ...
        <div class="page-bar">
            ...
            <div class="page-toolbar">
                <div class="btn-group pull-right">
                    <a href="{{route('activity.create')}}" class="btn btn-outline-primary">Create</a>
                </div>
            </div>
        </div>
        <!-- END PAGE BAR -->
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            <form method="POST" action="{{route('statusActivity',$item->id)}}">
                                            @method('PUT')
                                            @csrf
                                        ...
                                        <td>
                                            <a href="{{route('activity.front.show', $item->slug)}}" class="btn btn-info">Show</a>
                                        </td>
                                        <td> 
                                            <a href="{{route('activity.edit', $item->id)}}" class="btn btn-primary">Edit</a>
                                        </td>
                                        <td>
