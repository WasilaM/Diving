        ...
        <div class="page-bar">
            ...
            <div class="page-toolbar">
                <div class="btn-group pull-right">
                    <a href="{{route('course.create')}}" class="btn btn-outline-primary">Create</a>
                </div>
            </div>
        </div>
        <!-- END PAGE BAR -->
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            <form method="POST" action="{{route('statusCourse',$item->id)}}">
                                            @method('PUT')
                                            @csrf
                                        ...
                                        <td>
                                            <a href="{{route('course.front.show', $item->slug)}}" class="btn btn-info">Show</a>
                                        </td>
                                        <td> 
