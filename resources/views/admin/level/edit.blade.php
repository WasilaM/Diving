                        ...
                        <div class="tab-pane active" id="tab_0">
                            <div class="portlet box green">
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <form method="post" action="{{route('level.update', $level->id)}}" enctype="multipart/form-data" class="form-horizontal">
                                        @method('put')
                                        @csrf
                                            <input type="hidden" class="form-control input-circle" name="id" value="{{$level->id}}">
                                                        ...
                                                        @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                                            <div class="tab-pane fade @if ($loop->first) active in @endif " id="tab_lang_{{$localeCode}}">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-10">
                                                                        <input type="text" class="form-control" name="title[{{$localeCode}}]" value="{{$level->translate($localeCode)['title']}}">
                                                                    </div>
                                                                    @error('title')
